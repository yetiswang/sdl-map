...
(function () {
  ...
  function init() {
    ...
    var BEATS = [
      ...
      { id: 'alab', year: 2023, k: 3.2,
        en: ['A-Lab · Berkeley, with Coscientist · Pittsburgh', 'Forty-one of fifty-eight target compounds made in seventeen days of autonomous operation; the same year, a language model plans and runs experiments.', 'doi.org/10.1038/s41586-023-06734-w · doi.org/10.1038/s41586-023-06792-0 · Table 1, Canty & Abolhasani 2026'],
        zh: ['A-Lab · 伯克利，与 Coscientist · 匹兹堡', '十七天自主运行，五十八个目标化合物中合成出四十一个；同年，一个语言模型开始规划并执行实验。', 'doi.org/10.1038/s41586-023-06734-w · doi.org/10.1038/s41586-023-06792-0 · Table 1, Canty & Abolhasani 2026'],
        hant: ['A-Lab · 柏克萊，與 Coscientist · 匹茲堡', '十七天自主運行，五十八個目標化合物中合成出四十一個；同年，一個語言模型開始規劃並執行實驗。', 'doi.org/10.1038/s41586-023-06734-w · doi.org/10.1038/s41586-023-06792-0 · Table 1, Canty & Abolhasani 2026'] },
      { id: 'bigmap', year: 2023, k: 4.5,
        en: ['FINALES · Europe', 'Experiments and simulations run in several laboratories from one shared queue; Table 1 calls it decentralised control.', 'battery2030.eu · Table 1, Canty & Abolhasani 2026'],
        zh: ['FINALES · 欧洲', '几个实验室共用一个实验队列，实验与模拟分布执行；表 1 称之为去中心化控制。', 'battery2030.eu · Table 1, Canty & Abolhasani 2026'],
        hant: ['FINALES · 歐洲', '幾個實驗室共用一個實驗佇列，實驗與模擬分散執行；表 1 稱之為去中心化控制。', 'battery2030.eu · Table 1, Canty & Abolhasani 2026'] },
      { id: 'korea500', year: 2024, k: 4.5,
        en: ['Korea 500 SDL Initiative · Seoul', 'A national plan for five hundred self-driving labs by 2035, US$320M. In 2025 the US Genesis Mission names autonomous experimentation a foundational capability.', 'pubs.rsc.org (Digital Discovery, 2025) · Canty & Abolhasani 2026 on the Genesis Mission'],
        zh: ['韩国 500 自主实验室计划 · 首尔', '国家计划：到 2035 年建成五百个自主实验室，3.2 亿美元。2025 年，美国“创世使命”把自主实验列为基础能力。', 'pubs.rsc.org (Digital Discovery, 2025) · Canty & Abolhasani 2026 on the Genesis Mission'],
        hant: ['韓國 500 自主實驗室計畫 · 首爾', '國家計畫：到 2035 年建成五百個自主實驗室，3.2 億美元。2025 年，美國「創世使命」把自主實驗列為基礎能力。', 'pubs.rsc.org (Digital Discovery, 2025) · Canty & Abolhasani 2026 on the Genesis Mission'] },
