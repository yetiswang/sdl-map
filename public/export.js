...
(function () {
  ...
  function wire() {
    ...
    host.innerHTML =
      ...
      '<div class="exp-note">The export honours the sidebar filters (type, maturity, domain, characterisation, country). Narrow the selection there first, then pick a format. SVG stays vector-editable; PNG/JPEG render at 3200×2000; PDF wraps the raster on one page.</div>' +
      '</div></div>';
